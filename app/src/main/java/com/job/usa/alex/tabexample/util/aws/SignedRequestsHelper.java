...
/*
this code is for signing the REST request and generating the Signature, which is needed for authentication.
* */
public class SignedRequestsHelper {
    ...
    private String awsAccessKeyId = "AKIAI4WLDOFL2LVQQSMA";
    private String awsSecretKey = "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";
